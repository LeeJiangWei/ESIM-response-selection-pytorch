...
def main(train_file,
    ...
    with open(train_file, "rb") as pkl:
        train_data = DialogueDataset(pickle.load(pkl), max_context_length=300, max_response_length=30)
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        epoch_time, _, epoch_accuracy = validate(model, test_loader, criterion)
        print("-> Testing time: {:.4f}s, test accuracy: {:.4f}%\n"
              .format(epoch_time, (epoch_accuracy * 100)))
...
if __name__ == "__main__":
    main(
        train_file="tmp/douban/douban_train_data.pkl",
        valid_file="tmp/douban/douban_dev_data.pkl",
        test_file="tmp/douban/douban_test_data.pkl",
        embeddings_file="tmp/douban/embeddings.pkl",
        target_dir="tmp/douban_out",
    )
